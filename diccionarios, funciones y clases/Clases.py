...
if __name__ == '__main__':
    ...
    print(Student.get_total_students_class())  # 1

    estudiante.name = "Josesito"
    # Descomentar las siguientes líneas para verificar los valores de los atributos
    # print(estudiante.name)
    # print(estudiante.age)
    # print(estudiante)

    estudiante_2 = Student("Ana", 21, "Python", "Math")
    print(estudiante.get_total_students())  # 2
    print(Student.get_total_students_class())  # 2
